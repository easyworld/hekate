...
{
	lv_obj_t *win = nyx_create_standard_window(SYMBOL_SD" 分割槽管理器");
	...
	lv_label_set_static_text(lbl_notes,
		"注1: 最多隻能備份#C7EA46 1GB#資料. 如果超過此容量, 您將被要求在下一步手動備份.\n"
	...
	lv_label_set_static_text(label_btn2, SYMBOL_DOWNLOAD"  刷寫Linux");
